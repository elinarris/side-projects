...
form.addEventListener("submit", function (event) {
  ...
  const witnessName = localStorage.setItem("Witness Name", form.witnessName.value)
  const witnessPhone = localStorage.setItem("Witness Number", form.witnessPhone.value)


  const attorney = localStorage.setItem("Attorney?", form.attorney.value);
  const attorneyName = localStorage.setItem("Attorney Name", form.attorneyName.value)
  const attorneyPractice = localStorage.setItem("Attorney Practice", form.attorneyPractice.value)
  const attorneyUrl = localStorage.setItem("Attorney Url", form.attorneyUrl.value)
});
